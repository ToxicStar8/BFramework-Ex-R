...
namespace Framework
{
    ...
    public class BuildSpriteAtlas : Editor
    {
        ...
        /// 图集磁盘路径
        /// </summary>
        public static string SpritePath = Application.dataPath + "/Resources/Art/Sprite";

        /// <summary>
        /// 图片代码磁盘路径
        /// </summary>
        public static string SpriteScriptPath = Application.dataPath + "/Resources/Scripts/Define/AtlasSprite.cs";

        /// <summary>
        /// 图集代码磁盘路径
        /// </summary>
        public static string AtlasScriptPath = Application.dataPath + "/Resources/Scripts/Define/AtlasName.cs";
        ...
        private static void GenerateSpriteAtlas()
        {
            ...
            foreach (var item in pathDir.GetFileSystemInfos("*.*", SearchOption.TopDirectoryOnly))
            {
                ...
                if (parentDir != null)
                {
                    ...
                    var assetPath = "Assets/Resources/Art/Sprite/";
