...
namespace Framework
{
    ...
    public class AudioManager : ManagerBase
    {
        ...
        //背景音乐音量Key
        private const string _volumBackgroundKey = "VolumBackground";
        //音效音量Key
        private const string _volumSoundKey = "VolumSound"; 
        ...
        public void SetVolumeBackground(float volume)
        {
            ...
            PlayerPrefs.SetFloat(_volumBackgroundKey, _volumeBackground);
        }
        //音效音量
        ...
        { 
            ...
            PlayerPrefs.SetFloat(_volumSoundKey, _volumeSound);
        }
        ...
        {
            var audio = GameGod.Instance.LoadManager.LoadSyncByObjName<AudioClip>(audioName);
            //声音
            _backgroundAudio.volume = _volumeBackground;
            //如果在播放 先停止
